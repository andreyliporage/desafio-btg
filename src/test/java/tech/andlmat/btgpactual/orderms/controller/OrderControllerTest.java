...
import tech.andlmat.btgpactual.orderms.factory.OrderResponseFactory;
...
class OrderControllerTest {
    ...
    class ListOrders {
        ...
        void shouldReturnHttpOk() {
            ...
            doReturn(OrderResponseFactory.buildWithOneItem()).when(orderService).findAllCustomerId(anyLong(), any());
        ...
        void shouldPassCorrectParametersToService() {
            ...
            doReturn(OrderResponseFactory.buildWithOneItem()).when(orderService).findAllCustomerId(customerIdCaptor.capture(), pageRequestCaptor.capture());
        ...
        void shouldReturnResponseBodyCorrectly() {
            ...
            doReturn(pagination).when(orderService).findAllCustomerId(anyLong(), any());
            ...
            assertEquals(totalOnOrders, response.getBody().summary().get("totalOrders"));
