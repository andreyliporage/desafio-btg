package tech.andlmat.btgpactual.orderms.service;
...
import tech.andlmat.btgpactual.orderms.factory.OrderCreatedEventFactory;
import tech.andlmat.btgpactual.orderms.factory.OrderEntityFactory;
import tech.andlmat.btgpactual.orderms.repository.OrderRepository;
...
class OrderServiceTest {
    ...
    class FindAllCustomerId {
        ...
        void shouldCallRepository() {
            ...
            // ACT
            var response = orderService.findAllCustomerId(customerId, pageRequest);
        ...
        void shouldMapResponse() {
            ...
            assertEquals(page.getContent().getFirst().getOrderId(), response.getContent().getFirst().orderiId());
